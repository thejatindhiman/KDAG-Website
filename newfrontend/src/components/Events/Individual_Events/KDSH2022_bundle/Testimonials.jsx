  ...
  return (
    <>
      <div className="m-auto! w-[80%] relative z-15">
        ...
        <div className="flex max-[800px]:block">
          <Fade left>
            <div className="w-[50%] font-[1.2rem] p-[2rem]! max-[800px]:w-full hidden max-[800px]:block">
              <div className="text-[2.5rem] font-bold mb-[1rem]! text-[#d9dddc]!">
                <span className="uppercase">
          ...
          <Fade right>
            <div className="w-[50%] font-[1.2rem] p-[2rem]! max-[800px]:w-full past-nonmobile">
              <div className="text-[2.5rem] font-bold mb-[1rem]! text-[#d9dddc]! past-nonmobile">
                <span className="uppercase">
                  Kharagpur Data Science Hackathon, 1st Edition
                </span>
              </div>
