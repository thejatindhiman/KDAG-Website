...
const TestiMonialsDetails = ({testiMonialDetail}) => {
    ...
    return (
        <div class="item">
            <div class="bg-[rgba(255,255,255,0.1)] p-[20px]! rounded-[4px] text-center shadow-[0_19px_38px_rgba(0,0,0,0.1),0_15px_12px_rgba(0,0,0,0.02)] border-b border-l border-[rgba(255,255,255,0.1)] backdrop-blur-[5px]">
                <img class="max-h-[150px]! max-w-[150px]!" src={img} />
                <br />
